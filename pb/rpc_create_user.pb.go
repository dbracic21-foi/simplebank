...
func (x *CreatUserRequest) GetFullName() string {
	if x != nil {
		return x.FullName
	}
	return ""
...
var file_rpc_create_user_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7d, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x31, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x55,
	...
	0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74,
...
var file_rpc_create_user_proto_goTypes = []interface{}{
	...
	(*CreatUserResponse)(nil), // 1: pb.CreatUserResponse
	(*User)(nil),              // 2: pb.User
}
var file_rpc_create_user_proto_depIdxs = []int32{
	2, // 0: pb.CreatUserResponse.user:type_name -> pb.User
