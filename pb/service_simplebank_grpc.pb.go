...
func (c *simpleBankClient) VerifyEmails(ctx context.Context, in *VerifyEmailsRequest, opts ...grpc.CallOption) (*VerifyEmailsResponse, error) {
	out := new(VerifyEmailsResponse)
	err := c.cc.Invoke(ctx, SimpleBank_VerifyEmails_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSimpleBankServer) VerifyEmails(context.Context, *VerifyEmailsRequest) (*VerifyEmailsResponse, error) {
...
func _SimpleBank_VerifyEmails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyEmailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleBankServer).VerifyEmails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SimpleBank_VerifyEmails_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).VerifyEmails(ctx, req.(*VerifyEmailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SimpleBank_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SimpleBank_VerifyEmails_Handler,
		},
	},
