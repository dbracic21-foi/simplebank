...
mock:
	...
	mockgen -package mockwk -destination Worker/mock/distributor.go github.com/dbracic21-foi/simplebank/Worker TaskDistributor
...
.PHONY: postgres createdb dropdb migrateup migratedown migratedown1 migrateup1 new_migration db_docs db_schema sqlc test server mock proto redis 
